---
title: Installation
description: Install VibeLearn as a Claude Code plugin
---
...
The build compiles TypeScript → ESM hooks and ESM worker → bundles with esbuild. Output lands in `plugin/` and syncs to `~/.claude/plugins/marketplaces/vibelearn/`.
...
| `~/.claude/plugins/marketplaces/vibelearn/` | Installed plugin files |
