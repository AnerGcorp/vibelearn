...
describe('Summaries Module', () => {
  ...
  describe('storeSummary', () => {
    it('should store summary and return id and createdAtEpoch', () => {
      const memorySessionId = createSessionWithMemoryId('content-sum-123', 'vl-session-sum-123');
    ...
    it('should store all summary fields correctly', () => {
      const memorySessionId = createSessionWithMemoryId('content-sum-456', 'vl-session-sum-456');
      const project = 'test-project';
      const summary = createSummaryInput({
    ...
    it('should respect overrideTimestampEpoch', () => {
      const memorySessionId = createSessionWithMemoryId('content-sum-789', 'vl-session-sum-789');
      const project = 'test-project';
      const summary = createSummaryInput();
  ...
  describe('getSummaryForSession', () => {
    it('should retrieve summary by memory_session_id', () => {
      const memorySessionId = createSessionWithMemoryId('content-unique', 'unique-vl-session');
