...
describe('Version Consistency', () => {
  ...
  it('should have matching version in .claude-plugin/marketplace.json', () => {
    ...
    const vibeLearnPlugin = marketplaceJson.plugins.find((p: any) => p.name === 'vibelearn');
    expect(vibeLearnPlugin).toBeDefined();
    expect(vibeLearnPlugin.version).toBe(rootVersion);
  });
