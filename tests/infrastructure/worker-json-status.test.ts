...
// These tests spawn the real worker binary — only run when explicitly enabled
const SKIP_WORKER_CLI_TESTS = !process.env.RUN_WORKER_CLI_TESTS;
...
describe('worker-json-status', () => {
  ...
  (SKIP_WORKER_CLI_TESTS ? describe.skip : describe)('start command JSON output', () => {
   ...
   */
  (SKIP_WORKER_CLI_TESTS ? describe.skip : describe)('Claude Code hook framework compatibility', () => {
    /**
