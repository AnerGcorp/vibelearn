...
describe('Cursor Hooks JSON Utilities', () => {
  ...
  describe('getProjectName', () => {
    it('extracts basename from Unix path', () => {
      expect(getProjectName('/Users/atajanoviic/projects/my-project')).toBe('my-project');
    });

    it('extracts basename from Windows path', () => {
      expect(getProjectName('C:\\Users\\atajanoviic\\projects\\my-project')).toBe('my-project');
    });
  ...
  describe('integration: hook payload parsing', () => {
    ...
    it('extracts all fields from typical beforeSubmitPrompt payload', () => {
      const payload = {
        ...
        prompt: 'Fix the bug',
        workspace_roots: ['/Users/atajanoviic/projects/my-project'],
      ...
      expect(workspaceRoot).toBe('/Users/atajanoviic/projects/my-project');
