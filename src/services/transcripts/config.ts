...
export const DEFAULT_CONFIG_PATH = join(homedir(), '.vibelearn', 'transcript-watch.json');
export const DEFAULT_STATE_PATH = join(homedir(), '.vibelearn', 'transcript-watch-state.json');
