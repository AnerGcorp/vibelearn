#!/usr/bin/env bash
# test-e2e.sh — Run E2E test of vibelearn plugin on real OpenClaw
#
# Usage:
...
IMAGE_NAME="openclaw-vibelearn-e2e"

echo "=== Building E2E test image ==="
echo "  Base: ghcr.io/openclaw/openclaw:main"
echo "  Plugin: @vibelearn/openclaw-plugin (PR #1012)"
echo ""
...
if [ "${1:-}" = "--interactive" ]; then
  ...
  echo "  node openclaw.mjs plugins info vibelearn  # Plugin details"
