...
# vibelearn installer bootstrap
# Usage: curl -fsSL https://install.vibelearn.dev | bash
#   or:  curl -fsSL https://install.vibelearn.dev | bash -s -- --provider=gemini --api-key=YOUR_KEY

INSTALLER_URL="https://install.vibelearn.dev/installer.js"
...
info "vibelearn installer (Node.js v${NODE_VERSION})"

# Create temp file for installer
TMPFILE=$(mktemp "${TMPDIR:-/tmp}/vibelearn-installer.XXXXXX.mjs")
