#!/usr/bin/env bun
#!/usr/bin/env bun
"use strict";var B=Object.create;var x=Object.defineProperty;var G=Object.getOwnPropertyDescriptor;var J=Object.getOwnPropertyNames;var K=Object.getPrototypeOf,X=Object.prototype.hasOwnProperty;var Z=(e,n,t,s)=>{if(n&&typeof n=="object"||typeof n=="function")for(let r of J(n))!X.call(e,r)&&r!==t&&x(e,r,{get:()=>n[r],enumerable:!(s=G(n,r))||s.enumerable});return e};var ee=(e,n,t)=>(t=e!=null?B(K(e)):{},Z(n||!e||!e.__esModule?x(t,"default",{value:e,enumerable:!0}):t,e));var W=require("readline"),N=require("bun:sqlite"),q=require("path"),T=require("os"),m=require("fs");function O(e,n){let t=e+n;return t===0?0:e/t}function I(e){return e>=.85?"senior":e>=.5?"mid":"junior"}function M(e,n){let t=Math.floor(Date.now()/1e3),s=e.query("SELECT * FROM vl_developer_profile WHERE concept_name = ?").get(n.conceptName);if(!s){let p=n.isCorrect?1:0,l=n.isCorrect?0:1,v=O(p,l),f=n.isCorrect?1:0,S=I(v);return e.run(`INSERT INTO vl_developer_profile
       ...
       VALUES (?, ?, ?, ?, 1, ?, ?, ?, ?, ?)`,[n.conceptName,n.category,t,t,p,l,S,f,v]),{concept_name:n.conceptName,category:n.category,first_seen_at:t,last_seen_at:t,encounter_count:1,correct_answers:p,incorrect_answers:l,current_level:S,streak_count:f,mastery_score:v}}let r=s.correct_answers+(n.isCorrect?1:0),i=s.incorrect_answers+(n.isCorrect?0:1),c=O(r,i),a=n.isCorrect?s.streak_count+1:0,u=I(c);return e.run(`UPDATE vl_developer_profile SET
       last_seen_at       = ?,
       ...
       streak_count       = ?,
       mastery_score      = ?
     WHERE concept_name = ?`,[t,r,i,u,a,c,n.conceptName]),{...s,last_seen_at:t,encounter_count:s.encounter_count+1,correct_answers:r,incorrect_answers:i,current_level:u,streak_count:a,mastery_score:c}}function k(e,n){let t=new Date().toISOString().slice(0,10);e.query("SELECT questions_answered, correct_answers FROM vl_daily_streaks WHERE date = ?").get(t)?e.run(`UPDATE vl_daily_streaks SET
...
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501`),console.log("  VibeLearn Status"),console.log("\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501"),console.log(`  Sessions analyzed : ${n}`),console.log(`  Concepts captured : ${t}`),console.log(`  Quiz questions    : ${s} (${r} pending)`),console.log(`  Mastered concepts : ${c}`),i.length>0&&(console.log(`
  Top categories:`),i.forEach(a=>{console.log(`    ${a.category.padEnd(20)} ${a.count}`)})),console.log(`\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
...
`);return}let i=new N.Database(L),c=(0,W.createInterface)({input:process.stdin,output:process.stdout}),a=o=>new Promise(C=>c.question(o,C)),u=0,p=0,l=[...r],v=new Set(l.map(o=>o.id));console.log(`
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501`),console.log(`  VibeLearn Quiz \u2014 ${l.length} questions`),console.log(`\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
`);let f=0;for(;f<l.length;){let o=l[f],C=`Q${f+1}/${l.length}`,z=o.concept_name?` [${o.concept_name}]`:"";console.log(`
${C} (${o.difficulty})${z}`),o.snippet&&o.snippet.trim()&&(console.log(`
  Code:
`),o.snippet.split(`
`).forEach(y=>console.log(`    ${y}`)),console.log("")),console.log(`  ${o.question}
`);let g="",Y=Date.now();if(o.question_type==="multiple_choice"&&o.options_json)try{JSON.parse(o.options_json).forEach((E,_)=>{let w=String.fromCharCode(65+_);console.log(`  ${w}) ${E}`)}),console.log(""),g=(await a("  Your answer (A/B/C/D): ")).trim().toUpperCase()}catch{g=(await a("  Your answer: ")).trim()}else if(o.question_type==="fill_in_blank")g=(await a("  Fill in: ")).trim();else if(o.question_type==="ordering"&&o.options_json)try{JSON.parse(o.options_json).forEach((E,_)=>console.log(`  ${_+1}. ${E}`)),console.log(""),g=(await a("  Enter correct order (e.g. 2,4,1,3): ")).trim()}catch{g=(await a("  Your answer: ")).trim()}else o.question_type==="true_false"?g=(await a("  True or False? ")).trim().toLowerCase():(o.question_type==="open_ended"&&console.log("  (Open-ended \u2014 describe your reasoning, then press Enter)"),g=(await a("  Your answer: ")).trim());let V=Date.now()-Y,D=o.question_type==="open_ended",d=!1;!D&&o.correct!==null&&(d=g.toLowerCase()===o.correct.toLowerCase()),D?console.log(`
  \u270E Open-ended noted.
`):d?(console.log(`
  \u2713 Correct!
`),u++):console.log(`
...
`),Q(o,d,_.profile.current_level,v)){let w=H(o);l.splice(f+1,0,w),v.add(w.id),console.log(`  \u2795 Follow-up added: ${w.question.slice(0,60)}...
...
`)}async function ae(e,n){if(n){let s=j();if(s.api_key){let r=s.api_key.slice(0,6)+"..."+s.api_key.slice(-4);console.log(`
  Logged in: API key ${r}
`)}else console.log(`
...
`)}async function le(){let e=process.argv.slice(2);switch(e[0]){case"quiz":await ce(e.includes("--session"));break;case"status":await se();break;case"gaps":await ie();break;case"login":{let t=e.includes("--status"),s=t?null:e[1]??null;await ae(s,t);break}default:console.log(`
...
`)}}le().catch(e=>{console.error("Error:",e.message),process.exit(1)});
