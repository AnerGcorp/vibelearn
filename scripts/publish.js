...
async function publish() {
  try {
    console.log('📦 VibeLearn Marketplace Release Tool\n');
...
https://github.com/anergcorp/vibelearn"`);
    ...
    console.log(`\n🏷️  Tag: https://github.com/anergcorp/vibelearn/releases/tag/v${newVersion}`);
