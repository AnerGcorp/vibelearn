...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-atajanoviic-vibelearn/')
...
output_file = os.path.expanduser('~/Scripts/vibelearn/all_xml_fragments_with_timestamps.xml')
