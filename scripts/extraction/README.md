...
**Output:** `~/Scripts/vibelearn/actual_xml_only_with_timestamps.xml`
...
**Output:** `~/Scripts/vibelearn/all_xml_fragments_with_timestamps.xml`
...
Scripts read from: `~/.claude/projects/-Users-atajanoviic-vibelearn/*.jsonl`
