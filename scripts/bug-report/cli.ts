...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for vibelearn
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for vibelearn using the Claude Agent SDK.
...
async function main() {
  ...
  console.log(`   VibeLearn: v${diagnostics.versions.vibelearn}`);
  ...
  const githubUrl = `https://github.com/anergcorp/vibelearn/issues/new?title=${encodedTitle}&body=${encodedBody}`;
