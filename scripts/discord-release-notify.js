...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/anergcorp/vibelearn';

  const payload = {
    embeds: [
      {
        title: `🚀 vibelearn ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.vibelearn.dev](https://docs.vibelearn.dev)',
            inline: true,
          },
        ],
        footer: {
          text: 'vibelearn • Learning from Claude Code sessions',
        },
