 ...
 * 3. XDG path (~/.config/claude/plugins/marketplaces/vibelearn)
 * 4. Legacy path (~/.claude/plugins/marketplaces/vibelearn)
 */
function resolveRoot() {
  ...
  const marketplaceRel = join('plugins', 'marketplaces', 'vibelearn');
