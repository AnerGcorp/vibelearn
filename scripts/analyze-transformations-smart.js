...
//   "[Strategically Omitted by VibeLearn to save tokens]
//
...
// Configuration
const DB_PATH = path.join(homedir(), '.vibelearn', 'vibelearn.db');
const MAX_TRANSCRIPTS = parseInt(process.env.MAX_TRANSCRIPTS || '500', 10);

// Find transcript files (most recent first)
const TRANSCRIPT_DIR = path.join(homedir(), '.claude/projects/-Users-atajanoviic-vibelearn');
